  ...
  return (
    <div>
      ...
      <div className=' bg-zinc-900 text-white p-6 '>
        ...
        <section className='p-6    rounded-lg  gap-4 grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-2'>
          <div className=' flex flex-col gap-2'>
            <h2 className='text-3xl font-bold mb-4'>Sobre as aulas</h2>
            <p className='text-lg'>
              As aulas serão realizadas ao vivo via Discord, com duração de 1
              hora cada, em um servidor exclusivo para os alunos.
            </p>
          ...
          <div className=' flex flex-col gap-2'>
            ...
            <p className='text-lg'>Conheca mais sobre o educador</p>
            <Link to={'/'}>
